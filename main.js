...
class ProductManager{
    ...
    addProduct = (title,description,price,thumbnail,code,stock,id) => { 
        if(!this.products.find(i => i.code===code)){
...
productManager.addProduct("Banana","Banana ecuatoriana", 100, "https://img.freepik.com/foto-gratis/disparo-alto-angulo-platano-aislado-sobre-superficie-blanca_181624-29513.jpg?auto=format&h=200", "1zlf", 2);
